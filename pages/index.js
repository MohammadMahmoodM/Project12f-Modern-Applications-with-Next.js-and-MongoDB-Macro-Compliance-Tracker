...
const Home = ({data}) => {
  ...
  const getDataForPreviousDay = async () => {
    ...
    const res = await fetch('https://next-and-mongodb-macro-compliance-tracker/api/daily?date=' + newDate)
  ...
  const updateMacros = async () => {
    const res = await fetch('https://next-and-mongodb-macro-compliance-tracker/api/daily', {
      method: 'post',
